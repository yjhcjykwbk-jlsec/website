...
<div class="primary-div"><h4 class="title"> 最新内容 </h4><?php 
$fouritems=array(
  array("title"=>"最近新闻 News","desp"=>"吴云东课题组和港科大孙建伟课题组发表的研究..","img"=>"img/1.gif","href"=>""),
  array("title"=>"通知 Notices","desp"=>"深圳大学首届抗衰老与再生医学前.","img"=>"img/1.gif","href"=>""),
  array("title"=>"讲座 Seminars","desp"=>"special Seminar on Dec. 13...","img"=>"img/1.gif","href"=>""),
  array("title"=>"最近新闻 News","desp"=>"吴云东课题组和港科大孙建伟课题组发表的研究..","img"=>"img/1.gif","href"=>""),
  array("title"=>"通知 Notices","desp"=>"深圳大学首届抗衰老与再生医学前.","img"=>"img/1.gif","href"=>""),
  array("title"=>"讲座 Seminars","desp"=>"special Seminar on Dec. 13...","img"=>"img/1.gif","href"=>""),
  array("title"=>"最近新闻 News","desp"=>"吴云东课题组和港科大孙建伟课题组发表的研究..","img"=>"img/1.gif","href"=>""),
...
<div class="primary-div"><h4 class="title"> 服务项目</h4><?php 
$threelistitems=array(
  array("title"=>"讲座 Seminars","desp"=>"special Seminar on Dec. 13...","icon"=>"img/icon_phone.png","href"=>""),
  array("title"=>"讲座 Seminars","desp"=>"special Seminar on Dec. 13...","icon"=>"img/icon_phone.png","href"=>""),
  array("title"=>"讲座 Seminars","desp"=>"special Seminar on Dec. 13...","icon"=>"img/icon_phone.png","href"=>""),
  array("title"=>"讲座 Seminars","desp"=>"special Seminar on Dec. 13...","icon"=>"img/icon_phone.png","href"=>""),
  array("title"=>"讲座 Seminars","desp"=>"special Seminar on Dec. 13...","icon"=>"img/icon_phone.png","href"=>""),
